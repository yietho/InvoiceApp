...
public class LoginCommandHandler : IRequestHandler<LoginCommand, string>
{
    ...
    {
        var user = await _userRepository.GetByUserNameAsync(request.User.UserName);
        if (user == null || !_passwordHasher.VerifyPassword(request.User.Password, user.PasswordHash))
