...
namespace InvoiceApp.Persistence.Migrations
{
    ...
    [Migration("20250702200138_isplainpasswordAddedUserForTest")]
    partial class isplainpasswordAddedUserForTest
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("InvoiceApp.Domain.Entitites.User", b =>
                {
                    ...
                    b.Property<bool>("IsPlainPassword")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("InvoiceApp.Domain.Entitites.Customer", b =>
                {
                    b.HasOne("InvoiceApp.Domain.Entitites.User", "User")
                        .WithOne("Customer")
                        .HasForeignKey("InvoiceApp.Domain.Entitites.Customer", "UserId")
